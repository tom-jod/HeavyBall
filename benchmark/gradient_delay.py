...
def main(method: List[str] = typer.Option(['qr'], help='Eigenvector method to use (for SOAP)'),
    ...
    trial(model, data, None, loss_win_condition(win_condition_multiplier * 1e-4), steps * 2, opt[0], dtype[0], 1, 1,
          weight_decay, method[0], 1, 1, failure_threshold=5, base_lr=1e-3, trials=trials)  # Double steps, more attempts

...
python3 -m benchmark.run_all_benchmarks --steps 100000 --dtype float32 --trials 1000 --parallelism 256 --seeds 1 --difficulties "trivial" --opt="mars-AdamW" --opt="mars-AdamWScheduled" --timeout 55000
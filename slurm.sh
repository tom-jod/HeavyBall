...
python3 -m benchmark.run_all_benchmarks --steps 100000 --dtype float32 --trials 200 --parallelism 256 --seeds 1 --difficulties "medium" --opt="SGD" --opt="MARSAdamW" --timeout 155000 --exclude "wide_linear.py, minimax.py"